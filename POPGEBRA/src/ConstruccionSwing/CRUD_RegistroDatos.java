...
public class CRUD_RegistroDatos extends JFrame{

    public CRUD_RegistroDatos(){
        setTitle("Registro");
    ...
    private JPanel Contenedor(){
        ...
        contenedorFormulario.add(Texto("Ingrese tus datos", colores.Blanco, 20, "ITALIC"),c);
        c.insets = new Insets(0, 400, -50, 0);
        contenedorFormulario.add(Texto("Si eres profesor no agregues Carrera, ni grupo", colores.Blanco, 15, "ITALIC"),c);
        ...
        contenedorFormulario.add(ContenedorTexto("Ingrese su Boleta/numero de empleado"),c);
        c.insets = new Insets(0, 400, 150, 0);
        contenedorFormulario.add(ContenedorTexto("Ingrese su Carrera"),c);
        c.insets = new Insets(0, 400, 0, 0);
        contenedorFormulario.add(ContenedorTexto("Ingrese su Grupo"),c);
        c.insets = new Insets(0, 400, -150, 0);
        contenedorFormulario.add(ContenedorTexto("Ingrese su Contraseña"),c);
